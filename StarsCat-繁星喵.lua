...
local Window = OrionLib:MakeWindow({Name = "StarsCat", HidePremium = false, SaveConfig = false, IntroText = "注入器："..identifyexecutor(), ConfigFolder = "StarsCat"})
...
Tab:AddParagraph("作者","CUA脚本作者")
Tab:AddLabel("作者QQ：3290274245")
Tab:AddLabel("QQ群：282782261")
